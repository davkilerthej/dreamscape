...
<head>
    ...
    <title>Dreamscape - Survival</title>
...
<body>
    ...
    <main>
        <div class="gamemode-header">
            ...
            <h2>Survival</h2>
            <p>Experience the classic Minecraft survival experience with a twist! Build, explore, and survive in our custom world with unique features and challenges.</p>
        </div>
        ...
        <div class="gamemode-content">
            <div class="content-section">
                <h3>How to Play</h3>
                <ul>
                    <li>Start in a new world with basic tools</li>
                    <li>Gather resources and build your base</li>
                    <li>Explore the world and find unique biomes</li>
                    <li>Fight monsters and protect your territory</li>
            ...
            <div class="content-section">
                ...
                <ul>
                    ...
                    <li>Player economy and trading</li>
                    <li>Land claiming system</li>
                    <li>Custom mobs and events</li>
                    <li>Community projects and events</li>
                </ul>
            </div>
            ...
            <div class="content-section">
                ...
                <ul>
                    <li>Start near a village for trading</li>
                    <li>Build a secure base early</li>
                    <li>Join a community for protection</li>
                    <li>Participate in server events</li>
                    <li>Use the economy to your advantage</li>
                </ul>
            </div>
        </div>

        <a href="#" class="join-button">Join Survival Game</a>
    </main>
</body>
</html>
