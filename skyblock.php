...
<head>
    ...
    <title>Dreamscape - SkyBlock</title>
...
<body>
    ...
    <main>
        <div class="gamemode-header">
            ...
            <h2>SkyBlock</h2>
            <p>Start with a tiny island in the sky and build your empire! Farm, mine, and expand your island to become the ultimate SkyBlock master.</p>
        </div>
        ...
        <div class="gamemode-content">
            <div class="content-section">
                ...
                <ul>
                    ...
                    <li>Gather resources and build farms</li>
                    <li>Complete quests and challenges</li>
                    <li>Expand your island and unlock new areas</li>
            ...
            <div class="content-section">
                <h3>Features</h3>
                <ul>
                    <li>Custom island generation</li>
                    <li>Unique farming mechanics</li>
                    <li>Player shops and economy</li>
                    <li>Island upgrades and customization</li>
            ...
            <div class="content-section">
                ...
                <ul>
                    <li>Start with basic farms</li>
                    <li>Complete daily quests</li>
                    <li>Join a co-op for faster progress</li>
                    <li>Invest in island upgrades</li>
                    <li>Participate in events for rewards</li>
                </ul>
            </div>
        </div>

        <a href="#" class="join-button">Join SkyBlock Game</a>
    </main>
</body>
</html>
